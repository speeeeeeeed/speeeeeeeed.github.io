! function(e, t) {
    ...
    function h(e, t, n, i) {
        var r, o = 1,
            ...
            u = (he.cssNumber[t] || "px" !== c && +l) && Fe.exec(he.css(e, t));
        if (u && u[3] !== c) {
            c = c || u[3], n = n || [], u = +l || 1;
            do {
    ...
    function g(e) {
        var t, n = e.ownerDocument,
            i = e.nodeName,
            r = ze[i];
        return r || (t = n.body.appendChild(n.createElement(i)), r = he.css(t, "display"), t.parentNode.removeChild(t), "none" === r && (r = "block"), ze[i] = r, r)
    }

    function m(e, t) {
        for (var n, i, r = [], o = 0, a = e.length; o < a; o++) i = e[o], i.style && (n = i.style.display, t ? ("none" === n && (r[o] = De.get(i, "display") || null, r[o] || (i.style.display = "")), "" === i.style.display && Be(i) && (r[o] = g(i))) : "none" !== n && (r[o] = "none", De.set(i, "display", n)));
    ...
    function b(e, t, n, i, r) {
        for (var o, a, s, l, c, u, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++)
            if ((o = e[d]) || 0 === o)
                if ("object" === he.type(o)) he.merge(p, o.nodeType ? [o] : o);
                else if (Ye.test(o)) {
            for (a = a || f.appendChild(t.createElement("div")), s = (Qe.exec(o) || ["", ""])[1].toLowerCase(), l = Ue[s] || Ue._default, a.innerHTML = l[1] + he.htmlPrefilter(o) + l[2], u = l[0]; u--;) a = a.lastChild;
            he.merge(p, a.childNodes), a = f.firstChild, a.textContent = ""
        } else p.push(t.createTextNode(o));
        for (f.textContent = "", d = 0; o = p[d++];)
            if (i && he.inArray(o, i) > -1) r && r.push(o);
            else if (c = he.contains(o.ownerDocument, o), a = v(f.appendChild(o), "script"), c && y(a), n)
            for (u = 0; o = a[u++];) Xe.test(o.type || "") && n.push(o);
        return f
    }
    ...
    function O(e, t, i, r) {
        ...
        if (g || p > 1 && "string" == typeof h && !pe.checkClone && tt.test(h)) return e.each(function(n) {
            var o = e.eq(n);
            g && (t[0] = h.call(this, n, o.html())), O(o, t, i, r)
        });
        if (p && (o = b(t, e[0].ownerDocument, !1, e, r), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || r)) {
            for (s = he.map(v(o, "script"), _), l = s.length; f < p; f++) c = o, f !== d && (c = he.clone(c, !0, !0), l && he.merge(s, v(c, "script"))), i.call(e[f], c, f);
            if (l)
                for (u = s[s.length - 1].ownerDocument, he.map(s, S), f = 0; f < l; f++) c = s[f], Xe.test(c.type || "") && !De.access(c, "globalEval") && he.contains(u, c) && (c.src ? he._evalUrl && he._evalUrl(c.src) : n(c.textContent.replace(it, ""), u))
        }
        return e
    }
    ...
    function j(e, t, n) {
        ...
        return n = n || at(e), n && (a = n.getPropertyValue(t) || n[t], "" !== a || he.contains(e.ownerDocument, e) || (a = he.style(e, t)), !pe.pixelMarginRight() && ot.test(a) && rt.test(t) && (i = s.width, r = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = i, s.minWidth = r, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    function M(e, t, n, i, r) {
        var o, a = 0;
        for (o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2) "margin" === n && (a += he.css(e, n + $e[o], !0, r)), i ? ("content" === n && (a -= he.css(e, "padding" + $e[o], !0, r)), "margin" !== n && (a -= he.css(e, "border" + $e[o] + "Width", !0, r))) : (a += he.css(e, "padding" + $e[o], !0, r), "padding" !== n && (a += he.css(e, "border" + $e[o] + "Width", !0, r)));
        return a
    }
    ...
    function L(e, t, n) {
        ...
        if (e.getClientRects().length && (i = e.getBoundingClientRect()[t]), i <= 0 || null == i) {
            if (i = j(e, t, o), (i < 0 || null == i) && (i = e.style[t]), ot.test(i)) return i;
    ...
    function q() {
        dt && (e.requestAnimationFrame(q), he.fx.tick())
    }
    ...
    function R(e, t, n) {
        ...
        for (i in t)
            if (r = t[i], ht.test(r)) {
                ...
                d[i] = v && v[i] || he.style(e, i)
            } if ((l = !he.isEmptyObject(t)) || !he.isEmptyObject(d)) {
            f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], c = v && v.display, null == c && (c = De.get(e, "display")), u = he.css(e, "display"), "none" === u && (c ? u = c : (m([e], !0), c = e.style.display || c, u = he.css(e, "display"), m([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === he.css(e, "float") && (l || (p.done(function() {
                h.display = c
            }), null == c && (u = h.display, c = "none" === u ? "" : u)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always(function() {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            })), l = !1;
            for (i in d) l || (v ? "hidden" in v && (g = v.hidden) : v = De.access(e, "fxshow", {
                display: c
            }), o && (v.hidden = !g), g && m([e], !0), p.done(function() {
                g || m([e]), De.remove(e, "fxshow");
                for (i in d) he.style(e, i, d[i])
            })), l = B(g ? v[i] : 0, i, p), i in v || (v[i] = l.start, g && (l.end = l.start, l.start = 0))
        }
    }
    ...
    function W(e, t, n) {
        var i, r, o = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var t = pt || F(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, o = 1 - i, a = 0, l = c.tweens.length; a < l; a++) c.tweens[a].run(o);
        ...
        for (z(u, c.opts.specialEasing); o < a; o++)
            if (i = W.prefilters[o].call(c, e, u, c.opts)) return he.isFunction(i.stop) && (he._queueHooks(c.elem, c.opts.queue).stop = he.proxy(i.stop, i)), i;
        return he.map(u, B, c), he.isFunction(c.opts.start) && c.opts.start.call(e, c), he.fx.timer(he.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
    ...
    function U(e, t, n, i) {
        ...
        if (he.isArray(t)) he.each(t, function(t, r) {
            n || _t.test(e) ? i(e, r) : U(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
        });
    ...
    var be = function(e) {
        function t(e, t, n, i) {
            var r, o, a, s, l, u, p, d = t && t.ownerDocument,
                h = t ? t.nodeType : 9;
            if (n = n || [], "string" != typeof e || !e || 1 !== h && 9 !== h && 11 !== h) return n;
            if (!i && ((t ? t.ownerDocument || t : F) !== j && N(t), t = t || j, P)) {
                if (11 !== h && (l = ge.exec(e)))
                    if (r = l[1]) {
                        if (9 === h) {
                        ...
                        if ((r = l[3]) && x.getElementsByClassName && t.getElementsByClassName) return G.apply(n, t.getElementsByClassName(r)), n
                    } if (x.qsa && !W[e + " "] && (!D || !D.test(e))) {
                    if (1 !== h) d = t, p = e;
                    else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(be, xe) : t.setAttribute("id", s = q), u = k(e), o = u.length; o--;) u[o] = "#" + s + " " + f(u[o]);
                        p = u.join(","), d = me.test(e) && c(t.parentNode) || t
                    }
                    if (p) try {
        ...
        function p(e, t, n) {
            ...
            return t.first ? function(t, n, r) {
                ...
                if (l) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || a)
                            if (f = t[q] || (t[q] = {}), u = f[t.uniqueID] || (f[t.uniqueID] = {}), r && r === t.nodeName.toLowerCase()) t = t[i] || t;
                            else {
                                if ((c = u[o]) && c[0] === $ && c[1] === s) return p[2] = c[2];
        ...
        function m(e, t, n, r, o, a) {
            return r && !r[q] && (r = m(r)), o && !o[q] && (o = m(o, a)), i(function(i, a, s, l) {
                var c, u, f, p = [],
                    d = [],
                    m = a.length,
                    ...
                    b = n ? o || (i ? e : m || r) ? [] : a : y;
                if (n && n(y, b, s, l), r)
                    for (c = g(b, d), r(c, [], s, l), u = c.length; u--;)(f = c[u]) && (b[d[u]] = !(y[d[u]] = f));
                if (i) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (u = b.length; u--;)(f = b[u]) && (c = o ? Z(i, f) : p[u]) > -1 && (i[c] = !(a[c] = f))
                    }
            ...
            for (var t, n, i, r = e.length, o = w.relative[e[0].type], a = o || w.relative[" "], s = o ? 1 : 0, l = p(function(e) {
                ...
                if (n = w.relative[e[s].type]) u = [p(d(u), n)];
                    ...
                    if (n = w.filter[e[s].type].apply(null, e[s].matches), n[q]) {
                        ...
                        return m(s > 1 && d(u), s > 1 && f(e.slice(0, s - 1).concat({
                            value: " " === e[s - 2].type ? "*" : ""
            ...
            var r = n.length > 0,
                ...
                a = function(i, a, s, l, c) {
                    var u, f, p, d = 0,
                        ...
                        C = b.length;
                    for (c && (E = a === j || a || c); h !== C && null != (u = b[h]); h++) {
                        if (o && u) {
                            for (f = 0, a || u.ownerDocument === j || (N(u), s = !P); p = e[f++];)
                                if (p(u, a || j, s)) {
                                    l.push(u);
                                    break
                                } c && ($ = x)
        ...
        var b, x, w, C, T, k, _, S, E, I, O, N, j, A, P, D, M, L, H, q = "sizzle" + 1 * new Date,
            F = e.document,
            $ = 0,
            B = 0,
            R = n(),
        ...
        try {
            G.apply(U = K.call(F.childNodes), F.childNodes), U[F.childNodes.length].nodeType
        } catch (e) {
            G = {
        ...
        x = t.support = {}, T = t.isXML = function(e) {
            ...
            return i !== j && 9 === i.nodeType && i.documentElement ? (j = i, A = j.documentElement, P = !T(j), F !== j && (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), x.attributes = r(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), x.getElementsByTagName = r(function(e) {
                return e.appendChild(j.createComment("")), !e.getElementsByTagName("*").length
            }), x.getElementsByClassName = he.test(j.getElementsByClassName), x.getById = r(function(e) {
                return A.appendChild(e).id = q, !j.getElementsByName || !j.getElementsByName(q).length
            ...
            }, M = [], D = [], (x.qsa = he.test(j.querySelectorAll)) && (r(function(e) {
                A.appendChild(e).innerHTML = "<a id='" + q + "'></a><select id='" + q + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && D.push("[*^$]=" + ee + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || D.push("\\[" + ee + "*(?:value|" + J + ")"), e.querySelectorAll("[id~=" + q + "-]").length || D.push("~="), e.querySelectorAll(":checked").length || D.push(":checked"), e.querySelectorAll("a#" + q + "+*").length || D.push(".#.+[+~]")
            }), r(function(e) {
            ...
            })), (x.matchesSelector = he.test(L = A.matches || A.webkitMatchesSelector || A.mozMatchesSelector || A.oMatchesSelector || A.msMatchesSelector)) && r(function(e) {
                x.disconnectedMatch = L.call(e, "*"), L.call(e, "[s!='']:x"), M.push("!=", ie)
            }), D = D.length && new RegExp(D.join("|")), M = M.length && new RegExp(M.join("|")), t = he.test(A.compareDocumentPosition), H = t || he.test(A.contains) ? function(e, t) {
                ...
                return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === j || e.ownerDocument === F && H(F, e) ? -1 : t === j || t.ownerDocument === F && H(F, t) ? 1 : I ? Z(I, e) - Z(I, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return O = !0, 0;
                var n, i = 0,
                    r = e.parentNode,
                    ...
                    s = [e],
                    l = [t];
                if (!r || !o) return e === j ? -1 : t === j ? 1 : r ? -1 : o ? 1 : I ? Z(I, e) - Z(I, t) : 0;
                if (r === o) return a(e, t);
            ...
            if ((e.ownerDocument || e) !== j && N(e), n = n.replace(le, "='$1']"), x.matchesSelector && P && !W[n + " "] && (!M || !M.test(n)) && (!D || !D.test(n))) try {
                var i = L.call(e, n);
                if (i || x.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
            } catch (e) {}
            return t(n, j, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== j && N(e), H(e, t)
        }, t.attr = function(e, t) {
            ...
            var t, n = [],
                i = 0,
                r = 0;
            if (O = !x.detectDuplicates, I = !x.sortStable && e.slice(0), e.sort(Q), O) {
                    ...
                    return 1 === i && 0 === r ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [a ? m.firstChild : m.lastChild], a && y) {
                                for (p = m, f = p[q] || (p[q] = {}), u = f[p.uniqueID] || (f[p.uniqueID] = {}), c = u[e] || [], d = c[0] === $ && c[1], b = d && c[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (b = d = 0) || h.pop();)
                                    if (1 === p.nodeType && ++b && p === t) {
                                        u[e] = [$, d, b];
                                        break
                                    }
                            } else if (y && (p = t, f = p[q] || (p[q] = {}), u = f[p.uniqueID] || (f[p.uniqueID] = {}), c = u[e] || [], d = c[0] === $ && c[1], b = d), !1 === b)
                                for (;
                                    (p = ++d && p && p[g] || (b = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && (f = p[q] || (p[q] = {}), u = f[p.uniqueID] || (f[p.uniqueID] = {}), u[e] = [$, b]), p !== t)););
        ...
        return u.prototype = w.filters = w.pseudos, w.setFilters = new u, k = t.tokenize = function(e, n) {
            ...
            var n, i = [],
                ...
                o = W[e + " "];
            if (!o) {
                for (t || (t = k(e)), n = t.length; n--;) o = v(t[n]), o[q] ? i.push(o) : r.push(o);
            ...
            if (n = n || [], 1 === p.length) {
                if (o = p[0] = p[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && 9 === t.nodeType && P && w.relative[o[1].type]) {
                ...
                for (r = fe.needsContext.test(e) ? 0 : o.length; r-- && (a = o[r], !w.relative[s = a.type]);)
                    if ((l = w.find[s]) && (i = l(a.matches[0].replace(ve, ye), me.test(o[0].type) && c(t.parentNode) || t))) {
                        if (o.splice(r, 1), !(e = i.length && f(o))) return G.apply(n, i), n;
                        break
                    }
            }
            return (u || _(e, p))(i, t, !P, n, !t || me.test(e) && c(t.parentNode) || t), n
        }, x.sortStable = q.split("").sort(Q).join("") === q, x.detectDuplicates = !!O, N(), x.sortDetached = r(function(e) {
    ...
    he.fn.extend({
        ...
        he.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = he.filter(i, r)), this.length > 1 && (Ie[e] || he.uniqueSort(r), Ee.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var Oe = /[^\x20\t\r\n\f]+/g;
                                ...
                                var c = this,
                                    ...
                                    f = function() {
                                        ...
                                        if (!(t < a)) {
                                            ...
                                            f = e && ("object" == typeof e || "function" == typeof e) && e.then, he.isFunction(f) ? r ? f.call(e, o(a, n, s, r), o(a, n, l, r)) : (a++, f.call(e, o(a, n, s, r), o(a, n, l, r), o(a, n, s, n.notifyWith))) : (i !== s && (c = void 0, u = [e]), (r || n.resolveWith)(c, u))
                                        }
                                    },
                                    p = r ? f : function() {
                                        try {
    ...
    he.fn.ready = function(e) {
        ...
        ready: function(e) {
            (!0 === e ? --he.readyWait : he.isReady) || (he.isReady = !0, !0 !== e && --he.readyWait > 0 || je.resolveWith(te, [he]))
        }
    }), he.ready.then = je.then, "complete" === te.readyState || "loading" !== te.readyState && !te.documentElement.doScroll ? e.setTimeout(he.ready) : (te.addEventListener("DOMContentLoaded", u), e.addEventListener("load", u));
    ...
    f.uid = 1, f.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== i) {
                if (void 0 !== t) {
                    he.isArray(t) ? t = t.map(he.camelCase) : (t = he.camelCase(t), t = t in i ? [t] : t.match(Oe) || []), n = t.length;
                    for (; n--;) delete i[t[n]]
    ...
    he.extend({
        ...
        data: function(e, t) {
            var n, i, r, o = this[0],
                a = o && o.attributes;
            if (void 0 === e) {
                if (this.length && (r = Me.get(o), 1 === o.nodeType && !De.get(o, "hasDataAttrs"))) {
                    for (n = a.length; n--;) a[n] && (i = a[n].name, 0 === i.indexOf("data-") && (i = he.camelCase(i.slice(5)), d(o, i, r[i])));
    ...
    he.event = {
        ...
        add: function(e, t, n, i, r) {
            var o, a, s, l, c, u, f, p, d, h, g, m = De.get(e);
            if (m)
                for (n.handler && (o = n, n = o.handler, r = o.selector), r && he.find.matchesSelector(Ve, r), n.guid || (n.guid = he.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
                        return void 0 !== he && he.event.triggered !== t.type ? he.event.dispatch.apply(e, arguments) : void 0
                    }), t = (t || "").match(Oe) || [""], c = t.length; c--;) s = Ze.exec(t[c]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d && (f = he.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, f = he.event.special[d] || {}, u = he.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (p = l[d]) || (p = l[d] = [], p.delegateCount = 0, f.setup && !1 !== f.setup.call(e, i, h, a) || e.addEventListener && e.addEventListener(d, a)), f.add && (f.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, u) : p.push(u), he.event.global[d] = !0)
        },
        remove: function(e, t, n, i, r) {
            var o, a, s, l, c, u, f, p, d, h, g, m = De.hasData(e) && De.get(e);
            if (m && (l = m.events)) {
                for (t = (t || "").match(Oe) || [""], c = t.length; c--;)
                    if (s = Ze.exec(t[c]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
                        for (f = he.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, p = l[d] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = p.length; o--;) u = p[o], !r && g !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (p.splice(o, 1), u.selector && p.delegateCount--, f.remove && f.remove.call(e, u));
                        a && !p.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || he.removeEvent(e, d, m.handle), delete l[d])
                    } else
                        for (d in l) he.event.remove(e, d + t[c], n, i, !0);
            ...
            if (s.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, s)) {
                for (a = he.event.handlers.call(this, s, c), t = 0;
                    ...
                    for (s.currentTarget = r.elem, n = 0;
                        (o = r.handlers[n++]) && !s.isImmediatePropagationStopped();) s.rnamespace && !s.rnamespace.test(o.namespace) || (s.handleObj = o, s.data = o.data, void 0 !== (i = ((he.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l)) && !1 === (s.result = i) && (s.preventDefault(), s.stopPropagation()));
    ...
    ! function() {
        function t() {
            if (s) {
                ...
                n = "1%" !== t.top, o = "2px" === t.marginLeft, i = "4px" === t.width, s.style.marginRight = "50%", r = "4px" === t.marginRight, Ve.removeChild(a), s = null
            }
        }
    ...
    he.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, a, s = he.camelCase(t),
                    l = e.style;
                return t = he.cssProps[s] || (he.cssProps[s] = P(s) || s), a = he.cssHooks[t] || he.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (r = a.get(e, !1, i)) ? r : l[t] : (o = typeof n, "string" === o && (r = Fe.exec(n)) && r[1] && (n = h(e, t, r), o = "number"), void(null != n && n === n && ("number" === o && (n += r && r[3] || (he.cssNumber[s] ? "" : "px")), pe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l[t] = n))))
            }
        },
        css: function(e, t, n, i) {
            var r, o, a, s = he.camelCase(t);
            return t = he.cssProps[s] || (he.cssProps[s] = P(s) || s), a = he.cssHooks[t] || he.cssHooks[s], a && "get" in a && (r = a.get(e, !0, n)), void 0 === r && (r = j(e, t, i)), "normal" === r && t in ct && (r = ct[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), he.each(["height", "width"], function(e, t) {
        he.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !st.test(he.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? L(e, t, i) : Re(e, lt, function() {
                    return L(e, t, i)
                })
            },
            set: function(e, n, i) {
                var r, o = i && at(e),
                    a = i && M(e, t, i, "border-box" === he.css(e, "boxSizing", !1, o), o);
                return a && (r = Fe.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = he.css(e, t)), D(e, n, a)
            }
        }
        ...
        he.cssHooks[e + t] = {
            expand: function(n) {
                for (var i = 0, r = {}, o = "string" == typeof n ? n.split(" ") : [n]; i < 4; i++) r[e + $e[i] + t] = o[i] || o[i - 2] || o[0];
                return r
            }
        }, rt.test(e) || (he.cssHooks[e + t].set = D)
    }), he.fn.extend({
        css: function(e, t) {
    ...
    he.Animation = he.extend(W, {
            ...
            dt || (dt = e.requestAnimationFrame ? e.requestAnimationFrame(q) : e.setInterval(he.fx.tick, he.fx.interval))
        }, he.fx.stop = function() {
    ...
    he.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? he.prop(e, t, n) : (1 === o && he.isXMLDoc(e) || (r = he.attrHooks[t.toLowerCase()] || (he.expr.match.bool.test(t) ? mt : void 0)), void 0 !== n ? null === n ? void he.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = he.find.attr(e, t), null == i ? void 0 : i))
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    he.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : he.isFunction(e) ? this.each(function(n) {
                ...
                var t, i, r, o;
                if ("string" === n)
                    for (i = 0, r = he(this), o = e.match(Oe) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                else void 0 !== e && "boolean" !== n || (t = X(this), t && De.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : De.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
    ...
    he.fn.extend({
        val: function(e) {
            ...
            })) : r ? (t = he.valHooks[r.type] || he.valHooks[r.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : (n = r.value, "string" == typeof n ? n.replace(xt, "") : null == n ? "" : n)) : void 0
        }
    }), he.extend({
        valHooks: {
            option: {
    ...
    he.extend(he.event, {
        trigger: function(t, n, i, r) {
            var o, a, s, l, c, u, f, p = [i || te],
                d = ce.call(t, "type") ? t.type : t,
                h = ce.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = s = i = i || te, 3 !== i.nodeType && 8 !== i.nodeType && !wt.test(d + he.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), c = d.indexOf(":") < 0 && "on" + d, t = t[he.expando] ? t : new he.Event(d, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : he.makeArray(n, [t]), f = he.event.special[d] || {}, r || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                if (!r && !f.noBubble && !he.isWindow(i)) {
                    for (l = f.delegateType || d, wt.test(l + d) || (a = a.parentNode); a; a = a.parentNode) p.push(a), s = a;
                    s === (i.ownerDocument || te) && p.push(s.defaultView || s.parentWindow || e)
                }
                for (o = 0;
                    (a = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : f.bindType || d, u = (De.get(a, "events") || {})[t.type] && De.get(a, "handle"), u && u.apply(a, n), (u = c && a[c]) && u.apply && Pe(a) && (t.result = u.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = d, r || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(p.pop(), n) || !Pe(i) || c && he.isFunction(i[d]) && !he.isWindow(i) && (s = i[c], s && (i[c] = null), he.event.triggered = d, i[d](), he.event.triggered = void 0, s && (i[c] = s)), t.result
            }
        },
    ...
    he.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !he(this).is(":disabled") && It.test(this.nodeName) && !Et.test(e) && (this.checked || !We.test(e))
            }).map(function(e, t) {
                var n = he(this).val();
    ...
    Ft.href = Ct.href, he.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, s) {
                var c, p, d, x, w, C = n;
                u || (u = !0, l && e.clearTimeout(l), r = void 0, a = s || "", T.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, i && (x = K(h, T, i)), x = Z(h, x, T, c), c ? (h.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (he.lastModified[o] = w), (w = T.getResponseHeader("etag")) && (he.etag[o] = w)), 204 === t || "HEAD" === h.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = x.state, p = x.data, d = x.error, c = !d)) : (d = C, !t && C || (C = "error", t < 0 && (t = 0))), T.status = t, T.statusText = (n || C) + "", c ? v.resolveWith(g, [p, C, T]) : v.rejectWith(g, [T, C, d]), T.statusCode(b), b = void 0, f && m.trigger(c ? "ajaxSuccess" : "ajaxError", [T, h, c ? p : d]), y.fireWith(g, [T, C]), f && (m.trigger("ajaxComplete", [T, h]), --he.active || he.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var r, o, a, s, l, c, u, f, p, d, h = he.ajaxSetup({}, n),
                g = h.context || h,
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = he.param(h.data, h.traditional)), V(Lt, h, n, T), u) return T;
            f = he.event && h.global, f && 0 == he.active++ && he.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Dt.test(h.type), o = h.url.replace(Nt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ot, "+")) : (d = h.url.slice(o.length), h.data && (o += (kt.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (o = o.replace(jt, "$1"), d = (kt.test(o) ? "&" : "?") + "_=" + Tt++ + d), h.url = o + d), h.ifModified && (he.lastModified[o] && T.setRequestHeader("If-Modified-Since", he.lastModified[o]), he.etag[o] && T.setRequestHeader("If-None-Match", he.etag[o])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && T.setRequestHeader("Content-Type", h.contentType), T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + qt + "; q=0.01" : "") : h.accepts["*"]);
            for (p in h.headers) T.setRequestHeader(p, h.headers[p]);
            if (h.beforeSend && (!1 === h.beforeSend.call(g, T, h) || u)) return T.abort();
            if (C = "abort", y.add(h.complete), T.done(h.success), T.fail(h.error), r = V(Ht, h, n, T)) {
                if (T.readyState = 1, f && m.trigger("ajaxSend", [T, h]), u) return T;
    ...
    he.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = he.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(zt, "$1" + r) : !1 !== t.jsonp && (t.url += (kt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
            return a || he.error(r + " was not called"), a[0]
        }, t.dataTypes[0] = "json", o = e[r], e[r] = function() {
            a = arguments
        }, i.always(function() {
            void 0 === o ? he(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Rt.push(r)), a && he.isFunction(o) && o(a[0]), a = o = void 0
        }), "script"
        ...
        var i, r, o;
        return t || (pe.createHTMLDocument ? (t = te.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = te.location.href, t.head.appendChild(i)) : t = te), r = Te.exec(e), o = !n && [], r ? [t.createElement(r[1])] : (r = b([e], t, o), o && o.length && he(o).remove(), he.merge([], r.childNodes))
    }, he.fn.load = function(e, t, n) {
        var i, r, o, a = this,
            s = e.indexOf(" ");
        return s > -1 && (i = Q(e.slice(s)), e = e.slice(0, s)), he.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), a.length > 0 && he.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, r, o, a, s, l, c, u = he.css(e, "position"),
                f = he(e),
                p = {};
            "static" === u && (e.style.position = "relative"), s = f.offset(), o = he.css(e, "top"), l = he.css(e, "left"), c = ("absolute" === u || "fixed" === u) && (o + l).indexOf("auto") > -1, c ? (i = f.position(), a = i.top, r = i.left) : (a = parseFloat(o) || 0, r = parseFloat(l) || 0), he.isFunction(t) && (t = t.call(e, n, he.extend({}, s))), null != t.top && (p.top = t.top - s.top + a), null != t.left && (p.left = t.left - s.left + r), "using" in t ? t.using.call(e, p) : f.css(p)
        }
    }, he.fn.extend({
        offset: function(e) {
        ...
        he.cssHooks[t] = A(pe.pixelPosition, function(e, n) {
    ...
    return he.noConflict = function(t) {
        return e.$ === he && (e.$ = Qt), t && e.jQuery === he && (e.jQuery = Wt), he
    }, t || (e.jQuery = e.$ = he), he
}),
function(e) {
    ...
    v.prototype = {
        ...
        open: function(n) {
            ...
            return t.isIE7 && (v += " mfp-ie7"), v && t._addClassToMFP(v), t.updateItemHTML(), C("BuildControls"), e("html").css(g), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), t._lastFocusedEl = document.activeElement, setTimeout(function() {
                t.content ? (t._addClassToMFP(h), t._setFocus()) : t.bgOverlay.addClass(h), i.on("focusin" + d, t._onFocusIn)
            }, 16), t.isOpen = !0, t.updateSize(p), C(u), n
        },
        close: function() {
        ...
        updateItemHTML: function() {
            ...
            t.appendContent(a, i), n.preloaded = !0, C(f, n), r = n.type, t.container.prepend(t.contentContainer), C("AfterChange")
        },
        ...
        modules: [],
        open: function(t, n) {
            return k(), t = t ? e.extend(!0, {}, t) : {}, t.isObj = !0, t.index = n || 0,
    ...
    var S, E, I, O = "inline",
        N = function() {
            I && (E.after(I.addClass(S)).detach(), I = null)
        };
            ...
            getInline: function(n, i) {
                if (N(), n.src) {
                    ...
                    if (o.length) {
                        ...
                        a && a.tagName && (E || (S = r.hiddenClass, E = w(S), S = "mfp-" + S), I = o.after(E).detach().removeClass(S)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(A, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(A), j = t.st.ajax.cursor, x(s + "." + A, D), x("BeforeChange." + A, D)
            },
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, r, o) {
                        ...
                        C("ParseAjax", a), t.appendContent(e(a.data), A), n.finished = !0, P(), t._setFocus(), setTimeout(function() {
                            t.wrap.addClass(h)
        ...
        proto: {
            initImage: function() {
                ...
                t.types.push("image"), x(u + i, function() {
                    ...
                    n.cursor && e(document.body).removeClass(n.cursor), b.off("resize" + d)
                ...
                var n = 0,
                    ...
                    r = function(o) {
                        M && clearInterval(M), M = setInterval(function() {
                            return i.naturalWidth > 0 ? void t._onImageHasSize(e) : (n > 200 && clearInterval(M), n++, void(3 === n ? r(10) : 40 === n ? r(50) : 100 === n && r(500)))
                        }, o)
                    };
                r(1)
            },
            getImage: function(n, i) {
                var r = 0,
                    o = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, C("ImageLoadComplete")) : (r++, 200 > r ? setTimeout(o, 100) : a()))
                    },
                    a = function() {
    ...
    e.magnificPopup.registerModule(F, {
        ...
        proto: {
            initIframe: function() {
                t.types.push(F), x("BeforeChange", function(e, t, n) {
                    t !== n && (t === F ? $() : n === F && $(!0))
                }), x(s + "." + F, function() {
                    $()
                })
        ...
        proto: {
            initGallery: function() {
                ...
                return t.direction = !0, !(!n || !n.enabled) && (o += " mfp-gallery", x(u + r, function() {
                    ...
                    r.counter = a > 1 ? R(n.tCounter, o.index, a) : ""
                    ...
                    i.off(r), t.wrap.off("click" + r), t.arrowLeft && a && t.arrowLeft.add(t.arrowRight).destroyMfpFastClick(), t.arrowRight = t.arrowLeft = null
                }))
            },
            next: function() {
            ...
            proto: {
                initRetina: function() {
                    if (window.devicePixelRatio > 1) {
                        var e = t.st.retina,
                            n = e.ratio;
                        (n = isNaN(n) ? n() : n) > 1 && (x("ImageHasSize." + z, function(e, t) {
                            t.img.css({
                ...
                return e(this).each(function() {
                    ...
                    if (t) {
                        ...
                        a.on("touchstart" + i, function(e) {
                            u = !1, p = 1, f = e.originalEvent ? e.originalEvent.touches[0] : e.touches[0], l = f.clientX, c = f.clientY, b.on("touchmove" + i, function(e) {
                                f = e.originalEvent ? e.originalEvent.touches : e.touches, p = f.length, f = f[0], (Math.abs(f.clientX - l) > 10 || Math.abs(f.clientY - c) > 10) && (u = !0, n())
                            }).on("touchend" + i, function(e) {
                                n(), u || p > 1 || (o = !0, e.preventDefault(), clearTimeout(s), s = setTimeout(function() {
                                    o = !1
                                }, 1e3), r())
                            })
                        })
    ...
    e.mask = {
        ...
        mask: function(n, a) {
            ...
            return a = e.extend({
                ...
                completed: null
            }, a), l = e.mask.definitions, c = [], u = d = n.length, f = null, e.each(n.split(""), function(e, t) {
                "?" == t ? (d--, u = e) : l[t] ? (c.push(new RegExp(l[t])), null === f && (f = c.length - 1), u > e && (p = c.length - 1)) : c.push(null)
            }), this.trigger("unmask").each(function() {
                function s() {
                    if (a.completed) {
                        for (var e = f; p >= e; e++)
                            if (c[e] && I[e] === g(e)) return;
                        a.completed.call(E)
                    }
                }
                ...
                function y(e, t) {
                    ...
                    if (!(0 > e)) {
                        for (n = e, i = m(t); d > n; n++)
                            if (c[n]) {
                                if (!(d > i && c[n].test(I[i]))) break;
                                I[n] = I[i], I[i] = g(i), i = m(i)
                            } _(), E.caret(Math.max(f, e))
                    }
                }
                ...
                function b(e) {
                    ...
                    for (t = e, n = g(e); d > t; t++)
                        if (c[t]) {
                            if (i = m(t), r = I[t], I[t] = n, !(d > i && c[i].test(r))) break;
                            n = r
                        }
                }
                ...
                function x() {
                    ...
                    if (h && h.length && h.length > e.length) {
                        ...
                        if (0 === t.begin)
                            for (; t.begin < f && !c[t.begin];) t.begin++;
                        E.caret(t.begin, t.begin)
                    } else {
                        for (S(!0); t.begin < d && !c[t.begin];) t.begin++;
                        E.caret(t.begin, t.begin)
                    }
                    s()
                }
                ...
                function C(e) {
                    if (!E.prop("readonly")) {
                        ...
                        h = E.val(), 8 === o || 46 === o || i && 127 === o ? (t = E.caret(), n = t.begin, r = t.end, r - n == 0 && (n = 46 !== o ? v(n) : r = m(n - 1), r = 46 === o ? m(r) : r), k(n, r), y(n, r - 1), e.preventDefault()) : 13 === o ? w.call(this, e) : 27 === o && (E.val(N), E.caret(0, S()), e.preventDefault())
                    }
                }
                ...
                function T(t) {
                    if (!E.prop("readonly")) {
                        ...
                        if (!(t.ctrlKey || t.altKey || t.metaKey || 32 > a) && a && 13 !== a) {
                            if (l.end - l.begin != 0 && (k(l.begin, l.end), y(l.begin, l.end - 1)), n = m(l.begin - 1), d > n && (i = String.fromCharCode(a), c[n].test(i))) {
                                if (b(n), I[n] = i, _(), r = m(n), o) {
                                    var u = function() {
                ...
                function S(e) {
                    ...
                    for (t = 0, i = 0; d > t; t++)
                        ...
                        } else I[t] === r.charAt(i) && i++, u > t && (o = t);
                    return e ? _() : u > o + 1 ? a.autoclear || I.join("") === O ? (E.val() && E.val(""), k(0, d)) : _() : (_(), E.val(E.val().substring(0, o + 1))), u ? t : f
                }
                var E = e(this),
                ...
                E.data(e.mask.dataName, function() {
                    ...
                    if (!E.prop("readonly")) {
                        clearTimeout(t);
                        var e;
                        N = E.val(), e = S(), t = setTimeout(function() {
                            E.get(0) === document.activeElement && (_(), e == n.replace("?", "").length ? E.caret(0, e) : E.caret(e))
                        }, 10)
                    }
                }).on("blur.mask", w).on("keydown.mask", C).on("keypress.mask", T).on("input.mask paste.mask", function() {
...
function(e, t, n, i) {
    var r, o, a, s, l, c, u, f, p, d, h, g = "mPageScroll2id",
        m = "mPS2id",
        v = {
            scrollSpeed: 1300,
            autoScrollSpeed: !0,
        ...
        b = {
            init: function(i) {
                ...
                if (e(n).data(m, i), o = e(n).data(m), !this.selector) {
                    var c = "__" + m;
                    this.each(function() {
                        var t = e(this);
                ...
                r = r ? r + "," + this.selector : this.selector, o.defaultSelector && ("object" != typeof e(r) || 0 === e(r).length) && (r = ".m_PageScroll2id,a[rel~='m_PageScroll2id'],.page-scroll-to-id,a[rel~='page-scroll-to-id'],._ps2id"), o.clickEvents && e(n).undelegate("." + m).delegate(r, "click." + m, function(t) {
                    if (x._isDisabled.call(null)) return void x._removeClasses.call(null);
                    var n = e(this),
                        i = n.attr("href"),
                        r = n.prop("href");
                    i && -1 !== i.indexOf("#/") || (x._reset.call(null), d = n.data("ps2id-offset") || 0, x._isValid.call(null, i, r) && x._findTarget.call(null, i) && (t.preventDefault(), s = "selector", l = n, x._setClasses.call(null, !0), x._scrollTo.call(null)))
                    ...
                    t.each(function(n) {
                        var i = e(this),
                            r = i.attr("id"),
                            o = x._findHighlight.call(null, r);
                        x._setClasses.call(null, !1, i, o), n == t.length - 1 && x._extendClasses.call(null)
                    })
                }), a = !0, x._setup.call(null), x._live.call(null)
            },
            scrollTo: function(t, n) {
                ...
                if (t && void 0 !== t) {
                    ...
                    var i = {
                        ...
                        n = e.extend(!0, {}, i, n);
                    x._reset.call(null), f = n.layout, p = n.offset, t = -1 !== t.indexOf("#") ? t : "#" + t, x._isValid.call(null, t) && x._findTarget.call(null, t) && (s = "scrollTo", l = n.clicked, l && x._setClasses.call(null, !0), x._scrollTo.call(null))
                }
            },
            destroy: function() {
                e(t).unbind("." + m), e(n).undelegate("." + m).removeData(m), e("._" + m + "-t").removeData(m), x._removeClasses.call(null, !0)
            }
        },
        x = {
            ...
            _isValid: function(e, n) {
                if (e) {
                    n = n || e;
                    var i = -1 !== n.indexOf("#/") ? n.split("#/")[0] : n.split("#")[0],
                        r = t.location.toString().split("#")[0];
                    return "#" !== e && -1 !== e.indexOf("#") && ("" === i || i === r)
                }
            },
            _setup: function() {
                var t = x._highlightSelector(),
                    n = 1,
                    i = 0;
                return e(t).each(function() {
                    var r = e(this),
                        a = r.attr("href"),
                        s = r.prop("href");
                    if (x._isValid.call(null, a, s)) {
                        var l = -1 !== a.indexOf("#/") ? a.split("#/")[1] : a.split("#")[1],
                            c = e("#" + l);
                        if (c.length > 0) {
                            o.highlightByNextTarget && c !== i && (i ? i.data(m, {
                                tn: c
                            }) : c.data(m, {
                                tn: "0"
                            }), i = c), c.hasClass("_" + m + "-t") || c.addClass("_" + m + "-t"), c.data(m, {
                                i: n
                            }), r.hasClass("_" + m + "-h") || r.addClass("_" + m + "-h");
                            var u = x._findHighlight.call(null, l);
                            x._setClasses.call(null, !1, c, u), y = n, ++n == e(t).length && x._extendClasses.call(null)
                        }
                    }
                })
            },
            _highlightSelector: function() {
                return o.highlightSelector && "" !== o.highlightSelector ? o.highlightSelector : r
            },
            ...
            _findHighlight: function(n) {
                var i = t.location.toString().split("#")[0],
                    ...
                    a = e("._" + m + "-h[href='#/" + n + "']"),
                    s = e("._" + m + "-h[href='" + i + "#/" + n + "']");
                return r = r.length > 0 ? r : o, a = a.length > 0 ? a : s, a.length > 0 ? a : r
            },
            _setClasses: function(t, n, i) {
                var r = o.clickedClass,
                    a = o.targetClass,
                    s = o.highlightClass;
                t && r && "" !== r ? (e("." + r).removeClass(r), l.addClass(r)) : n && a && "" !== a && i && s && "" !== s && (x._currentTarget.call(null, n) ? (n.addClass(a), i.addClass(s)) : (!o.keepHighlightUntilNext || e("." + s).length > 1) && (n.removeClass(a), i.removeClass(s)))
            },
            _extendClasses: function() {
                var t = o.targetClass,
                    ...
                    l = n + "-first",
                    c = n + "-last";
                e("._" + m + "-t").removeClass(a + " " + s), e("._" + m + "-h").removeClass(l + " " + c), o.forceSingleHighlight ? o.keepHighlightUntilNext && i.length > 1 ? (i.slice(0, 1).removeClass(t), r.slice(0, 1).removeClass(n)) : (i.slice(1).removeClass(t), r.slice(1).removeClass(n)) : (i.slice(0, 1).addClass(a).end().slice(-1).addClass(s), r.slice(0, 1).addClass(l).end().slice(-1).addClass(c))
            },
            _removeClasses: function(t) {
                e("." + o.clickedClass).removeClass(o.clickedClass), e("." + o.targetClass).removeClass(o.targetClass + " " + o.targetClass + "-first " + o.targetClass + "-last"), e("." + o.highlightClass).removeClass(o.highlightClass + " " + o.highlightClass + "-first " + o.highlightClass + "-last"), t && (e("._" + m + "-t").removeClass("_" + m + "-t"), e("._" + m + "-h").removeClass("_" + m + "-h"))
            },
            _currentTarget: function(n) {
                var i = o["target_" + n.data(m).i],
                    r = n.data("ps2id-target"),
                    a = r ? e(r)[0].getBoundingClientRect() : n[0].getBoundingClientRect();
                if (void 0 !== i) {
                    var s = n.offset().top,
                        l = n.offset().left,
                        c = i.from ? i.from + s : s,
                        u = i.to ? i.to + s : s,
                        f = i.fromX ? i.fromX + l : l,
                        p = i.toX ? i.toX + l : l;
                    return a.top >= u && a.top <= c && a.left >= p && a.left <= f
                }
                var d = e(t).height(),
                    h = e(t).width(),
                    g = r ? e(r).height() : n.height(),
                    v = r ? e(r).width() : n.width(),
                    y = 1 + g / d,
                    b = y,
                    x = d > g ? y * (d / g) : y,
                    w = 1 + v / h,
                    C = w,
                    T = h > v ? w * (h / v) : w,
                    k = [a.top <= d / b, a.bottom >= d / x, a.left <= h / C, a.right >= h / T];
                if (o.highlightByNextTarget) {
                    var _ = n.data(m).tn;
                    if (_) {
                        var S = _[0].getBoundingClientRect();
                        "vertical" === o.layout ? k = [a.top <= d / 2, S.top > d / 2, 1, 1] : "horizontal" === o.layout && (k = [1, 1, a.left <= h / 2, S.left > h / 2])
                    }
                }
                return k[0] && k[1] && k[2] && k[3]
            },
            _scrollTo: function() {
                o.scrollSpeed = parseInt(o.scrollSpeed), u = o.pageEndSmoothScroll ? x._pageEndSmoothScroll.call(null) : u;
                var n = e("html,body"),
                    i = o.autoScrollSpeed ? x._autoScrollSpeed.call(null) : o.scrollSpeed,
                    r = n.is(":animated") ? o.scrollingEasing : o.scrollEasing,
                    a = e(t).scrollTop(),
                    s = e(t).scrollLeft();
                switch (f) {
                    case "horizontal":
                        s != u[1] && (x._callbacks.call(null, "onStart"), n.stop().animate({
                            scrollLeft: u[1]
                        }, i, r).promise().then(function() {
                            x._callbacks.call(null, "onComplete")
                        }));
                        break;
                    case "auto":
                        if (a != u[0] || s != u[1])
                            if (x._callbacks.call(null, "onStart"), navigator.userAgent.match(/(iPod|iPhone|iPad|Android)/)) {
                                var l;
                                n.stop().animate({
                                    pageYOffset: u[0],
                                    pageXOffset: u[1]
                        ...
                        break;
                    default:
                        a != u[0] && (x._callbacks.call(null, "onStart"), n.stop().animate({
                            scrollTop: u[0]
                        }, i, r).promise().then(function() {
                            x._callbacks.call(null, "onComplete")
                        }))
            ...
            _pageEndSmoothScroll: function() {
                var i = e(n).height(),
                    ...
                    o = e(t).height(),
                    a = e(t).width();
                return [i - u[0] < o ? i - o : u[0], r - u[1] < a ? r - a : u[1]]
            },
            _autoScrollSpeed: function() {
                var i = e(t).scrollTop(),
                    ...
                    a = e(n).height(),
                    s = e(n).width(),
                    l = [o.scrollSpeed + o.scrollSpeed * Math.floor(Math.abs(u[0] - i) / a * 100) / 100, o.scrollSpeed + o.scrollSpeed * Math.floor(Math.abs(u[1] - r) / s * 100) / 100];
            ...
            _live: function() {
                h = setTimeout(function() {
                    o.live ? e(x._highlightSelector()).length !== y && x._setup.call(null) : h && clearTimeout(h), x._live.call(null)
                }, 1e3)
            },
            _easing: function() {
                ...
                }, e.easing.easeInBack = e.easing.easeInBack || function(e, t, n, r, o, a) {
                    return a == i && (a = 1.70158), r * (t /= o) * t * ((a + 1) * t - a) + n
                }, e.easing.easeOutBack = e.easing.easeOutBack || function(e, t, n, r, o, a) {
                    return a == i && (a = 1.70158), r * ((t = t / o - 1) * t * ((a + 1) * t + a) + 1) + n
                }, e.easing.easeInOutBack = e.easing.easeInOutBack || function(e, t, n, r, o, a) {
                    return a == i && (a = 1.70158), (t /= o / 2) < 1 ? r / 2 * t * t * ((1 + (a *= 1.525)) * t - a) + n : r / 2 * ((t -= 2) * t * ((1 + (a *= 1.525)) * t + a) + 2) + n
    ...
    x._easing.call(), e.fn[g] = function(t) {
        return b[t] ? b[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error("Method " + t + " does not exist") : b.init.apply(this, arguments)
    }, e[g] = function(t) {
        return b[t] ? b[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error("Method " + t + " does not exist") : b.init.apply(this, arguments)
    }, e[g].defaults = v
}(jQuery, window, document), $(document).ready(function() {
    function e() {
        $(".hamburger").hasClass("is-active") ? $(".mobile_menu").addClass("active") : $(".mobile_menu").removeClass("active")
    }

    function t() {
        $(r).not(":checked") && ($(r).closest("form").find(".input_style").attr("disabled", !0), $(r).closest("form").find(".btn").attr("type", "button")), $(r).is(":checked") && ($(r).closest("form").find(".input_style").attr("disabled", !1), $(r).closest("form").find(".btn").attr("type", "submit"))
    }
    ...
    function n() {
        ...
        $(".foreign_passport_box_header,.foreign_passport_box_info,.foreign_passport_box_text").css({
            height: "auto"
        }), e($(".foreign_passport_container .foreign_passport_box_header")), e($(".foreign_passport_container .foreign_passport_box_info")), e($(".foreign_passport_container .foreign_passport_box_text")), $(window).width() <= 991 ? $(".section_contacts_box .contacts_box_map_header").each(function() {
            $(this).prependTo($(this).closest(".section_contacts_container").find(".map_box"))
        }) : $(".map_box .contacts_box_map_header").each(function() {
            $(this).prependTo($(this).closest(".section_contacts_container").find(".section_contacts_box"))
        })
    }
    ...
    function i() {
        var e = new ymaps.Map("map", {
            ...
            n = new ymaps.Map("map2", {
                center: a,
                zoom: 16
            }),
            i = new ymaps.Placemark(a, {
                balloonContent: "" + $("#map2").data("balloon2")
            }),
            r = new ymaps.Map("map3", {
                center: map_coordinate3,
                zoom: 16
            }),
            s = new ymaps.Placemark(map_coordinate3, {
                balloonContent: "" + $("#map3").data("balloon3")
            }),
            l = new ymaps.Map("map4", {
                center: map_coordinate4,
                zoom: 16
            }),
            c = new ymaps.Placemark(map_coordinate4, {
                balloonContent: "" + $("#map4").data("balloon4")
            }),
            u = new ymaps.Map("map5", {
                center: map_coordinate5,
                zoom: 16
            }),
            f = new ymaps.Placemark(map_coordinate5, {
                balloonContent: "" + $("#map5").data("balloon5")
            }),
						g = new ymaps.Map("map6", {
                center: map_coordinate6,
                zoom: 16
            }),
            h = new ymaps.Placemark(map_coordinate6, {
                balloonContent: "" + $("#map6").data("balloon6")
            });
        e.geoObjects.add(t), n.geoObjects.add(i), r.geoObjects.add(s), l.geoObjects.add(c), u.geoObjects.add(f), g.geoObjects.add(h)
    }
    $("body").append("<div class='mobile_menu hidden-lg hidden-md'></div>"), $(".head a.logo").clone().appendTo(".mobile_menu"), $(".head ul.menu").clone().appendTo(".mobile_menu"), $(".hamburger, .menu_a").click(function() {
            $(".hamburger").toggleClass("is-active"), e()
        }), $(document).on("click", function(t) {
            $(t.target).closest(".mobile_menu, .hamburger").length || ($(".hamburger").removeClass("is-active"), e(), t.stopPropagation())
        }), $(".contacts_top .contacts_top_office").clone().attr("id", "contacts_top_office").addClass("anim-dialog clearfix row-flex").appendTo("body>.hidden"), $("#contacts_top_office").append("<li><strong>Отдел бронирования туров:</strong><a href='tel:+78129050185'>+7 (812) 905-01-85</a>,<a href='tel:+78129050185'>+7 (812)  905-01-85</a></li>"),
        $(".header .style_form").clone().attr("id", "popup_form").addClass("anim-dialog").find(".warning_checkbox").attr("id", "warning2").parent(".warning").find("label").attr("for", "warning2").closest("form").appendTo("body>.hidden");
    var r;
    $(".warning input.warning_checkbox").change(function() {
        r = this, t()
    }), $(".warning_checkbox").prop("checked", !0), $(".menu a.menu_a").mPageScroll2id({
        offset: 44,
        scrollSpeed: 1e3
    }), $("input[name='phone']").mask("+7 (999) 999 99 99"), $("a.popup_form").click(function() {
        $("#popup_form .form_info").val($(".hidden .country").text()), $("#popup_form .warning_checkbox").prop("checked", !0), $(this).hasClass("travel_agents") ? ($("#popup_form").addClass("travel_agents_form"), $("#popup_form .email_form").attr("disabled", !1), $("#popup_form .form_info").val("Заявка от турагента " + $(".hidden .country").text()), $("#popup_form .form_subtitle").text("на сотрудничество с нами и мы Вам перезвоним")) : ($("#popup_form").removeClass("travel_agents_form"), $("#popup_form .email_form").attr("disabled", !0), $("#popup_form .form_subtitle").text($("#header_form .form_subtitle").text()))
        ...
        midClick: !0,
        removalDelay: 300,
        mainClass: "my-mfp-anim-script",
        callbacks: {
            open: function() {}
        }
    }), $(".thx a").click(function() {
        return $(".thx").magnificPopup("close"), !1
    }), $("#header_form,#popup_form,#section7_form").submit(function() {
        var e = $(this);
        return $.ajax({
            type: "POST",
            url: "mail.php",
    ...
    var o = $("#map").data("coordinate1"),
        a = $("#map2").data("coordinate2");
    map_coordinate3 = $("#map3").data("coordinate3"), map_coordinate4 = $("#map4").data("coordinate4"), map_coordinate5 = $("#map5").data("coordinate5"), map_coordinate6 = $("#map6").data("coordinate6"), ymaps.ready(i)
});
if ($(window).width() <= '960') {
    $('.section_foreign_passport').before($('.section_widget_tours'));
}
$(document).ready(function() {
    $(".section5 .col-xs-6").each(function() {
        $(this).addClass("section5_item_index" + $(this).index() + "");
    })

    function resize_function() {

        if ($(window).width() <= 991) {
            $(".section5 .col-xs-6").hide();
            var i = 0;
            while (i < 8) {
                i++;
                $(".section5 .col-xs-6.section5_item_index" + i + "").show();
            }
        } else {
            $(".section5 .col-xs-6").show();
        }
